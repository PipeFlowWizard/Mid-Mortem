...
public class EntityStats : ScriptableObject
{
    ...
    public int maxHealth = 100;                                        // Base maxHealth of Entities is 100
    public int mp = 100;                                            // Base mp of Entities is 100
    public int attackDamage = 10;                                         // Base attack of Entity is 10
    public int rangedAttackSpeed = 3;                                     // Base time between Enemy ranged attacks is 3 seconds  --> time between attacks
    public int meleeAttackSpeed = 2;                                      // Base time between Enemy melee attacks is 2 seconds   --> time between attacks
    ...
    public float detectionRange = 15.0f;                                 // Base attack range of Entity is 15
    public float meleeRange = 5.0f;                                // Base melee attack range of Entity is 5
    public float rangedAttackRange = 12.0f;
